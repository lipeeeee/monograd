...
class MathMixin:
  ...
  # un
  def log(self):   return self._unop(Ops.LOG)
  def exp(self):   return self._unop(Ops.EXP)
  def sqrt(self):  return self._unop(Ops.SQRT)
  def sin(self):   return self._unop(Ops.SIN)
  def relu(self):  return self._unop(Ops.RELU)
